...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        l1.setFont(new Font("Raleway", Font.BOLD, 21));
        ...
        accountDetails.add(r1);
        accountDetails.add(r2);
        accountDetails.add(r3);
        accountDetails.add(r4);
        ...
        number.setFont(new Font("Raleway", Font.BOLD, 21));
        ...
        pnumber.setFont(new Font("Raleway", Font.BOLD, 21));
        pnumber.setBounds(330,370,300,30);
        add(pnumber);
        
        JLabel services = new JLabel("Services Required");
        services.setFont(new Font("Raleway", Font.BOLD, 21));
